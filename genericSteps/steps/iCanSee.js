/*! openui5-generic-app-testing 2019-05-17 */
...
(function() {
    ...
    module.exports = {
        docs: {
            ...
            examples: [ "I can see btnNext", "I can see btnNext with text 'next' in Detail view", "I can see lblTitle in Overview view", "I can see txtInput with value '1234ABCD' in Main view", "I can see txtInput with value containing '123' in Main view", "I can see txt-input with value containing '123'", "I can see the 21st sap.m.Button control deeply nested inside grp-buttons with text 'Apples' in Main view", "I can see the sap.m.Button control deeply nested inside grpButtons" ]
        },
        icon: "show",
